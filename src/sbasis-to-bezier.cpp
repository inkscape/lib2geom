...
// mutating
void
subpath_from_sbasis(Geom::PathSetBuilder &pb, multidim_sbasis<2> const &B, double tol, bool initial) {
    assert(B.is_finite());
...
*/
void
subpath_from_sbasis_incremental(Geom::PathSetBuilder &pb, multidim_sbasis<2> B, double tol, bool initial) {
