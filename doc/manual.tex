...
TODO: Justify this design choice
...
A Path is an ordered set of \code{Curve}s.  A \code{Path} in
Inkscape is drawn in a single fill and stroke.

\section{Curve}

Curves define a continuous segments which yields points for values of t in
the range of [0,1].  The startpoint is defined at t=0, and the endpoint
defined at t=1.

2Geom has a diversity of curve types and conversions between them, because
certain representations do certain things better than others.  
